...
func newUniverseMoon(db *gorm.DB, opts ...gen.DOOption) universeMoon {
	...
	_universeMoon.Name = field.NewString(tableName, "name")
	_universeMoon.PositionX = field.NewFloat64(tableName, "position_x")
	_universeMoon.PositionY = field.NewFloat64(tableName, "position_y")
	_universeMoon.PositionZ = field.NewFloat64(tableName, "position_z")
